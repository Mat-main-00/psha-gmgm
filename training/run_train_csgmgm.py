...
Training the CS-GMGM.
"""

from pathlib import Path
import torch
from pkgs.models.csgmgm import train_csgmgm

torch.cuda.empty_cache()

dataset_file = Path("../data/dataset_csgmgm.csv")
out_dir = Path("../out_data/csgmgm")
